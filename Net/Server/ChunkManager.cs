...
namespace Aetheris
{
    ...
    public class ChunkManager
    {
        ...
        {
            var columns = new WorldGen.ColumnData[Config.CHUNK_SIZE, Config.CHUNK_SIZE];
            
            int baseX = coord.X * Config.CHUNK_SIZE;
            int baseZ = coord.Z * Config.CHUNK_SIZE;
            ...
            {
                Parallel.For(0, Config.CHUNK_SIZE, lx =>
                {
        ...
        public float SampleDensityFast(int worldX, int worldY, int worldZ, ChunkCoord coord)
        {
            ...
            int lx = worldX - (coord.X * Config.CHUNK_SIZE);
            int lz = worldZ - (coord.Z * Config.CHUNK_SIZE);

            lx = Math.Clamp(lx, 0, Config.CHUNK_SIZE - 1);
            lz = Math.Clamp(lz, 0, Config.CHUNK_SIZE - 1);
